...
- (NSString *)getURLbyKey:(NSString *)URLKey{
    ...
    return [NSMutableString stringWithFormat:@"%@%@", REQUEST_HEAD, URLKey];
}
                     ...
                     fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:REQUEST_LOGIN];
                               ...
                               fail:(void (^)(NSString *description))fail
{
    ...
    if (project) {
        [parameters setObject:project forKey:@"project"];
    }
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:REQUEST_GET_CODE];
                                      ...
                                      fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:REQUEST_CHECKED_CODE];
                               ...
                               fail:(void (^)(NSString *description))fail
{
    ...
    if (identityCard) {
        [parameters setObject:identityCard forKey:@"identityCard"];
    }
    if (account) {
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:SAVE_IDENTITY_CARD];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
               ...
               fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATE_PWD];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                       ...
                                       fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:JUDGE_BLOCK_ID];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                        ...
                                        fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:BLOCK_ID_PHONE_CODE];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 *找回密码验证
                                   ...
                                   fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:FIND_PWD];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                       ...
                                       fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:FIND_BLOCK_ID_CODE];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                              ...
                                              fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:FIND_BLOCK_ID];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                               ...
                               fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:FIND_UPDATE_PWD];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                    ...
                    fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_PROPERTY];
                             ...
                             fail:(void (^)(NSString *description))fail
{
    ...
    if (row) {
        [parameters setObject:row forKey:@"row"];
    }
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_OTC];
    
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 获取Kyc认证等级/token/project固定空字符串
 *(REQUEST_WHETHERKYC/token/project)
 * @param token     token
 * @param project      ""(固定空字符串)
 */
                                 ...
                                 fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:REQUEST_WHETHERKYC];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                    ...
                                    fail:(void (^)(NSString *description))fail
{
    ...
    if (blockToken) {
        [parameters setObject:blockToken forKey:@"blockToken"];
    }
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:WHETHER_KYC_CONTENT];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                              ...
                              fail:(void (^)(NSString *description))fail
{
    ...
    if (frontUrl) {
        [parameters setObject:frontUrl forKey:@"frontUrl"];
    }
    if (backUrl) {
        [parameters setObject:backUrl forKey:@"backUrl"];
    }
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:EGG_IDENTITY_CARD];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                       ...
                                       fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_SAFETY_BY_ID];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                    ...
                                    fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:WHETHER_FUN_PWD];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                           ...
                           fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATE_PWD2];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                                   ...
                                                   fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:FUN_PWD_CODE];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                        ...
                        fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:SAVE_FUND_PWD];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                                   ...
                                                   fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATE_PHONE_CODE];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                                        ...
                                                        fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATE_CODE_CONFIRM];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 绑定手机号获取验证码
                                                     ...
                                                     fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATE_PHONE_CODE_NEW];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 绑定手机号
                             ...
                             fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATE_PHONE];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                           ...
                                           fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATE_EMAIL_CODE_NEW];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                 ...
                 fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATE_EMAIL];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                       ...
                       fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATE_EMAIL_CODE];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                              ...
                                              fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATE_EMAIL_CODE_CONFIRM];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}

/**
 * 公告
 *(GET_Message/token可传可不传/page/row  1已读 0未查看)
 * @param token     token
 * @param page      page
 * @param row       row
 */
                  ...
                  fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_Message];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                  ...
                                  fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_Address];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 添加本人常用地址
                         ...
                         fail:(void (^)(NSString *description))fail
{
    ...
    if (addressName) {
        [parameters setObject:addressName forKey:@"name"];
    }
    if (type) {
        [parameters setObject:type forKey:@"type"];
    }
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:SAVE_Address];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                            ...
                            fail:(void (^)(NSString *description))fail
{
    ...
    if (idAddress) {
        [parameters setObject:idAddress forKey:@"id"];
    }
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:DELETE_Address];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                            ...
                            fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATE_Address];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 查询他人地址
                      ...
                      fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:SELECT_Address];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                      ...
                      fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_BIDTWALLET];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 判断kyc跟密码/
                ...
                fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:WHETHERKYCORFUNDPWD];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 验证资金密码/
                          ...
                          fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:VERIFYFUNDPWD];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
                            ...
                            fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:WITHDRAWDEPOSIT];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 交易详情/token/id
                          ...
                          fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_BIDTWALLETCONTENT];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 更新/
                   ...
                   fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:MOBILEVERSIONNUMBER];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 币管家首页币/token
                           ...
                           fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_HK_COUNT];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 币管家首页昨日币累积币/token
                                  ...
                                  fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_PR0FIT_BY_TOKEN];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 币管家已投人数
...
{
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_HK_PEOPLENUM];
    [self getHttpWithUrlStr:URLString success:success fail:fail];
}
/**
 * 币管家首页/page/rows
 *(GET_HK_LIST
                              ...
                              fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_HK_LIST];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 币管家项目详情/id
                                ...
                                fail:(void (^)(NSString *description))fail
{
    NSMutableDictionary *parameters = [NSMutableDictionary dictionary];
    if (id_ID) {
        [parameters setObject:id_ID forKey:@"id"];
    }
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_HK_BY_ID];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                            ...
                            fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:HKPAY];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                    ...
                                    fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_HK_PAYINFO];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                                        ...
                                        fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_HK_PAYDETAILSBYID];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 币管家是否投资过项目/token
                               ...
                               fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_USER_PAYINFOSTATE];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 币管家是否投资过项目/token
                            ...
                            fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_USER_PAYISTATE];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                      ...
                      fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_CONTRACTADRESS];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 获取祝福语列表
                      ...
                      fail:(void (^)(NSString *description))fail
{
    NSMutableDictionary *parameters = [NSMutableDictionary dictionary];
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_LUCKBAGBLESSLIST];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                  ...
                  fail:(void (^)(NSString *description))fail
{
    ...
    if (bidtnum) {
        [parameters setObject:bidtnum forKey:@"bidtnum"];
    }
    if (bagnum) {
        [parameters setObject:bagnum forKey:@"bagnum"];
    }
    if (lbid) {
        [parameters setObject:lbid forKey:@"lbid"];
    }
    if (token) {
        [parameters setObject:token forKey:@"token"];
    }
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:HANDLUCKBAG_type_1];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                  ...
                  fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:HANDLUCKBAG_type_2];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                              ...
                              fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_ACCEPLUCKBAGHISTORY];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 收到红包记录/token/page/rows
                             ...
                             fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_SENDLUCKBAGHISTORY];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 红包记录详情/id/token
                             ...
                             fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_LUCKBAGINFO];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 是否开启蛋生游戏0关闭1开启
                    ...
                    fail:(void (^)(NSString *description))fail
{
    NSMutableDictionary *parameters = [NSMutableDictionary dictionary];
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:EGGCONTROL];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
                      ...
                      fail:(void (^)(NSString *description))fail
{
    NSMutableDictionary *parameters = [NSMutableDictionary dictionary];
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_BETBANNER];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
           ...
           fail:(void (^)(NSString *description))fail
{
    NSMutableDictionary *parameters = [NSMutableDictionary dictionary];
    if (oid) {
        [parameters setObject:oid forKey:@"oid"];
    }
    if (token) {
        [parameters setObject:token forKey:@"token"];
    }
    if (betnum) {
        [parameters setObject:betnum forKey:@"betnum"];
    }
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:BET];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
          ...
          fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_BETLIST];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 选择币种 type=2
                  ...
                  fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_COINLIST];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
            ...
            fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:CHARGE];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 充币记录token
              ...
              fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_CHARGEHISTORY];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
 * 充币详情id
               ...
               fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:CHARGEINfO];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
                      ...
                      fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:CHECKCHARGESTATE];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
                 ...
                 fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:GET_CHARGEINfO];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
                ...
                fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:UPDATEADDRESS];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
/**
                ...
                fail:(void (^)(NSString *description))fail
{
    ...
    //拼接:URL_Server+keyURL
    NSString *URLString = [self getURLbyKey:BINDINGADDRESS];
    [self postHttpWithDic:parameters urlStr:URLString success:success fail:fail];
}
#pragma mark - 获取公共资源 get请求 底层 post数据请求和图片上传
/**
 * Post请求数据
 */
- (void)postHttpWithDic:(NSDictionary *)jsParameters
                 urlStr:(NSString *)urlStr
                success:(void (^)(NSDictionary *resultDic))success //成功
                   fail:(void (^)(NSString *description))fail      //失败
{
    NSLog(@"post请求URL：%@***请求参数：%@",urlStr,jsParameters);
    AFHTTPSessionManager *manager = [HttpHelper shareSessionManager];
...
//    manager.responseSerializer.acceptableContentTypes = [NSSet setWithObject:@"text/html"];
    [manager POST:urlStr parameters:jsParameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        NSLog(@"请求URL：%@***请求成功返回数据：%@",urlStr,responseObject);
        success(responseObject);

    } failure:^(NSURLSessionDataTask * _Nullable task, NSError * _Nonnull error) {
        NSLog(@"请求URL：%@***请求失败返回数据：%@",urlStr,error.description);
